...
echo scoring...
$YB/build/cpp/score -p 0.50 -c cluster_assignments -v ex.users_* | sort -n | tee temp_scores_inbetween |  $YB/yeahbutter/recover_netflix_titles.pl ex.map_articles ../../movie_titles.txt ../average_scores /dev/stdin | sort -n > temp_scores
